...
# num_tests=20 #how many test spans to predict. maximum 20, as ground truth is always split into 20 segments.
num_tests=2
...
#transform ground truth to xy components
...
if model_type=="ODE"
    ...
    #and with dt=1/1024 and non adaptive time stepping. hcat the output solution.u and save it as a csv.
    dt=0.1
